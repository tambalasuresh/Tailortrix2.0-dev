...
const FabricItems=()=>{
  ...
  const handleFileChange = (event) => {
      ...
      const getFabricSvg=(url)=>{
        const frontImage=document.getElementById("front_svg");
        const backImage=document.getElementById("back_svg");
        console.log("Front Svg Color",frontImage.children[0].children[0]);
        console.log("Front Path Color",frontImage.children[0].children[0].children[0].style.fill=`${url}`);
    ...
    return(
        ...
        <div id="defaultFabric">
                ...
                <div className="fabric_container" ref={buttonContainerRef}>
        ...
        <div className="uploadFabric" id="uploadFabric">
