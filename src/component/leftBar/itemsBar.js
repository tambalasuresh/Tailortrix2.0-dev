...
import "./leftBar.css";
import BlouseItems from "./blouse";
import ColorItems from "./color";
        ...
        <div className="container-fluid p-0">
            ...
            <div className="col item_div">
                           ...
                           <button className={activeIcon ===2 ?
                            ...
                            ' btn icon_style text-uppercase active_icon' :'btn icon_style text-uppercase'} 
                            onClick={()=>GetOther(5)}>Other</button>
            </div>  
                    </div>    
                    {isBlouse && 
            ...
            {/* <div className="row bg-info footer_menu">
                <div className="col-lg-12">
                    <div className="row">
                        <div className="col-lg-2 item_div">
                           <button className={activeIcon ===6 ?
                            ' btn icon_style text-uppercase active_icon' :'btn icon_style text-uppercase'} 
                            onClick={()=>GetBlouse(6)}>Sleeves</button>
                        </div>
                        <div className="col-lg-2 item_div">
                           <button className={activeIcon ===7 ?
                            ' btn icon_style text-uppercase active_icon' :'btn icon_style text-uppercase'} 
                            onClick={()=>GetBlouse(7)}>Patches</button>
                        </div>
                        <div className="col-lg-2 item_div">
                           <button className={activeIcon ===8 ?
                            ' btn icon_style text-uppercase active_icon' :'btn icon_style text-uppercase'} 
                            onClick={()=>GetBlouse(8)}>Necks</button>
                        </div>
                        <div className="col-lg-2 item_div">
                           <button className={activeIcon ===9 ?
                            ' btn icon_style text-uppercase active_icon' :'btn icon_style text-uppercase'} 
                            onClick={()=>GetBlouse(9)}>color</button>
                        </div>
                        <div className="col-lg-2 item_div">
                           <button className={activeIcon ===10 ?
                            ' btn icon_style text-uppercase active_icon' :'btn icon_style text-uppercase'} 
                            onClick={()=>GetBlouse(10)}>fabrics</button>
                        </div>
